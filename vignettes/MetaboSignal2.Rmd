...
datasets, containing the following information:<br><br>
  ...
  sign depending on the tissue. The user can update/edit this matrix as required. <br><br>
...
## unique(keggNet_example[, "interaction_type"])
```
...
## unique(keggNet_example_clean[, "interaction_type"])
```
<br>
